                ...
                while ($homeEvent->have_posts()){ $homeEvent->the_post(); ?>
                    ...
                    <div class="event-summary">
                        ...
                        <div class="event-summary__content">
                            ...
                            <p><?php if(has_excerpt()){echo get_the_excerpt();}else{echo wp_trim_words(get_the_content(),17);} ?> <a href="<?php the_permalink() ?>" class="nu gray">Learn more</a></p>
                        </div>
                    </div>
...
<!--                $dog->derinkwater();
so have_post and the_post reffering to default query for  resolving this issue $query->have_post and $query->the_post
-->
                <?php
                $arg=array(
                  'posts_per_page'=>2    ,
...
//                    'post_type'=>'page'
                ...
                while ($customQuery->have_posts()){ $customQuery->the_post();?>
                    <div class="event-summary">
                        ...
                        <div class="event-summary__content">
                            <h5 class="event-summary__title headline headline--tiny"><a href="<?php the_permalink() ?>"><?php the_title(); ?></a></h5>
                            <p><?php if(has_excerpt()){echo get_the_excerpt();}else { echo wp_trim_words(get_the_content(),17);} ?><a href="#" class="nu gray">Read more</a></p>
                        </div>
                    </div>
